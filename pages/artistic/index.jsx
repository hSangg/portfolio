    ...
    <>
      ...
      <motion.div className=''>
        <Image
          alt=''
          loading='lazy'
          src={'/GFXPlugin.com.url@0.5x.jpg'}
          width={'2000px'}
          height={'700px'}
          objectFit='cover'
        />
        ...
        <motion.div className='flex-1'>
          ...
          <motion.div>
            ...
            <motion.p className='text-paragraph'>
              Trong này sẽ chứa những nghệ sĩ mình
              yêu thích, những bài hát{' '}
              <b>siêu hay siêu cháy</b>, từ những
              bài{' '}
              <b>
                <i>
                  quẩy banh nóc tới nước mắt hai
                  hàng
                </i>
              </b>{' '}
              {'{=}'}
